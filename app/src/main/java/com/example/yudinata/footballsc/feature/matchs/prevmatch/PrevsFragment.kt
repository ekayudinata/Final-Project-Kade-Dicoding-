...
class PrevsFragment : Fragment(), AnkoComponent<Context>, PrevsView {

    private var prevs: MutableList<EventItem> = mutableListOf()
    private lateinit var presenter: PrevsPresenter
    private lateinit var adapter: PrevsAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val gson = Gson()
        presenter = PrevsPresenter(this, request, gson)
//
